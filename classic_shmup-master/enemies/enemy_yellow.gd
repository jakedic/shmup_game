...
# Optional: Override take_damage for bee enemy specific behavior
'''func take_damage(damage_amount: int = 1):
	# Bee enemies take less damage? Or have special effect?
	# For example: bee enemies flash yellow when hit
