...
const DURATION := 0.25
# Keep in sync with PollinatedStatus.EXPLOSION_RADIUS so the visual matches
# the actual area that gets pollinated/damaged.
const MAX_RADIUS := PollinatedStatus.EXPLOSION_RADIUS
